...
<html>
  <head>
    ...
    <title>pytz - World Timezone Definitions for Python &mdash; slide 0.1.0 ドキュメント</title>
...
<article class="slide level-1" id="pytz-world-timezone-definitions-for-python">
...
<article class="slide level-3" id="localized-times-and-date-arithmetic">
...
<article class="slide level-3" id="tzinfo-api">

<h3><code class="docutils literal"><span class="pre">tzinfo</span></code> API</h3>
...
<article class="slide level-2" id="problems-with-localtime">
...
<article class="slide level-2" id="country-information">
...
<article class="slide level-2" id="what-is-utc">
...
<article class="slide level-2" id="helpers">
...
<article class="slide level-2" id="internationalization-i18n-l10n">
...
<article class="slide level-2" id="latest-versions">
...
<article class="slide level-2" id="bugs-feature-requests-patches">
...
<article class="slide level-2" id="issues-limitations">
...
<article class="slide level-2" id="contact">
